...
const createEventPhotoTemplate = (photos) => {
...
const createPhotosContainerTemplate = (photos) => {
  return `<div class="event__photos-container">
            <div class="event__photos-tape">
                ${createEventPhotoTemplate(photos)}
            </div>
          </div>`;
};

export const createEventsCreateFormTemplate = (event) => {
              ...
              <section class="event__details">
                ...
                <section class="event__section  event__section--destination">
                  ...
                  <p class="event__destination-description">${description}</p>
                    ${pics.length !== 0 ? createPhotosContainerTemplate(pics) : ``}
                </section>
              </section>
            </form>
          </li>`;
